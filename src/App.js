...
function App() {
  ...
  const API = `https://api.weatherapi.com/v1/forecast.json?key=c7ee0cc80be146ca8a4182556222412&q=${city}&days=${3}&aqi=no&alerts=no`;
        ...
        <div className="header">
          ...
          <div className="header_bottom">
            <p>
              Weather in{" "}
              <strong>
                {isLoaded && weatherData.location.name + ", " + weatherData.location.country}
              </strong>
            </p>
          </div>
        </div>
